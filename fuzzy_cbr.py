...
class Fuzzy:
    def __init__(self):
        ...
        self.alpha['medium'] = fuzz.trimf(self.alpha.universe, [0.5, 0.7, 0.7])
        self.alpha['high'] = fuzz.trimf(self.alpha.universe, [0.7, 1, 1])
    ...
    def IsolatedObstacle(self, obstacle_angle, distance):
        ...
        # OK
        rules_isolated.append(ctrl.Rule(self.distance_to_obstacle['medium'] & self.angle['frontal'], self.alpha['low']))
